  ...
  async execute(message) {
    const embed = new EmbedBuilder()
      ...
      .setDescription(
        ...
        '[**Profic Art Fight Bot full Document – Google Docs**](https://docs.google.com/document/d/1FtqzjUpLgx8J4nWUxm-aMWzbo7msvnl6vIbzQKvUhL8/preview?tab=t.0#heading=h.dlrvqsooc0h)\n\n' +
